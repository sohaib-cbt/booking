                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-xxl-9 col-xl-8 col-12">
                                        <div class="tab-content" id="wizard-tabContent">
                                            <div class="tab-pane fade {{ $activeTab === 'centre_home_community' ? 'show active' : '' }}"
                                                id="wizard-contact" role="tabpanel" aria-labelledby="wizard-contact-tab">
                                                @include('admin.booking.edit_booking.edit_centre_home_community')
                                            </div>

                                            <div class="tab-pane fade {{ $activeTab === 'school' ? 'show active' : '' }}"
                                                id="wizard-cart" role="tabpanel" aria-labelledby="wizard-cart-tab">
                                                @include('admin.booking.edit_booking.edit_school')
                                            </div>

                                            <div class="tab-pane fade custom-input {{ $activeTab === 'fsp_csp' ? 'show active' : '' }}"
                                                id="wizard-banking" role="tabpanel" aria-labelledby="wizard-banking-tab">
