...
<form class="row g-3 needs-validation custom-input" action="{{ route('bookings.fsp.form') }}" method="POST">
    @csrf
        ...
        <div class="row g-3">
                ...
                <div class="input-group">
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" type="radio" name="child_attend" value="yes"
                            {{ old('child_attend', 'yes') == 'yes' ? 'checked' : '' }}>
                    </div>
            ...
            <div class="col-xxl-4 col-sm-6">
                ...
                <input class="form-control @error('alayacare_service_code') is-invalid @enderror"
                    ...
                    placeholder="Enter service code" value="{{ old('alayacare_service_code') }}">
            ...
            <div class="col-xxl-4 col-sm-6">
                ...
                <input class="form-control @error('schedule_by') is-invalid @enderror" name="schedule_by" type="text"
                    placeholder="Enter schedule by" value="{{ old('schedule_by') }}">
                @error('schedule_by')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-xxl-4 col-sm-6">
                ...
                <input class="form-control @error('location') is-invalid @enderror" id="validationemail-b"
                    type="text" name="location" placeholder="Enter location" value="{{ old('location') }}"
                    required>
                @error('location')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="col-xxl-4 col-sm-6">
                ...
                <select class="form-select @error('area_of_town') is-invalid @enderror" name="area_of_town">
                    ...
                    <option value="central" {{ old('area_of_town') == 'central' ? 'selected' : '' }}>Central
                    </option>
                        ...
                        <div data-repeater-item class="row align-items-end mb-3">
                                ...
                                <select
                                    ...
                                    @foreach ($internal_teams as $internal_team)
                                        <option value="{{ $internal_team->name }}"
                                            ...
                                            {{ old("internal_team.$index.name") == $internal_team->name ? 'selected' : '' }}>
                                            {{ $internal_team->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    value="{{ old("internal_team.$index.role") }}" placeholder="">
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    value="{{ old("internal_team.$index.phone") }}" placeholder="">
                            ...
                            <div class="col-md-2 d-flex align-items-end">
                                 <svg data-repeater-delete height="24" viewBox="0 0 512 512" width="24" xmlns="http://www.w3.org/2000/svg" id="fi_10308565">
                                        <g id="Layer_2" data-name="Layer 2"><g id="cross"><circle id="background" cx="256" cy="256" fill="#ff2147" r="256"></circle>
                                            <path d="m312.75 256 76.72-76.72a22.29 22.29 0 0 0 0-31.53l-25.22-25.22a22.29 22.29 0 0 0 -31.53 0l-76.72 76.72-76.72-76.72a22.29 22.29 0 0 0 -31.53 0l-25.22 25.22a22.29 22.29 0 0 0 0 31.53l76.72 76.72-76.72 76.72a22.29 22.29 0 0 0 0 31.53l25.22 25.22a22.29 22.29 0 0 0 31.53 0l76.72-76.72 76.72 76.72a22.29 22.29 0 0 0 31.53 0l25.22-25.22a22.29 22.29 0 0 0 0-31.53z" fill="#fff"></path>
                                        </g></g></svg>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="repeater">
                ...
                <div data-repeater-list="external_team">
                    @php
                        $externalTeams = old('external_team', [[]]);
                    @endphp
                        ...
                        <div data-repeater-item class="row align-items-end mb-3">
                            <div class="col-xxl-5 col-sm-6">
                                ...
                                <input class="form-control @error("external_team.$index.name") is-invalid @enderror"
                                    ...
                                    placeholder="Enter name" value="{{ old("external_team.$index.name") }}">
                            ...
                            <div class="col-xxl-5 col-sm-6">
                                ...
                                <input class="form-control @error("external_team.$index.phone") is-invalid @enderror"
                                    ...
                                    placeholder="Enter phone" value="{{ old("external_team.$index.phone") }}">
                            ...
                            <div class="col-xxl-2 col-sm-6 d-flex align-items-end">
                                {{-- <i class="fas fa-times-circle text-danger fa-2x" data-repeater-delete style="cursor:pointer;"></i> --}}
                                    <svg data-repeater-delete height="24" viewBox="0 0 512 512" width="24" xmlns="http://www.w3.org/2000/svg" id="fi_10308565">
                                        <g id="Layer_2" data-name="Layer 2"><g id="cross"><circle id="background" cx="256" cy="256" fill="#ff2147" r="256"></circle>
                                            <path d="m312.75 256 76.72-76.72a22.29 22.29 0 0 0 0-31.53l-25.22-25.22a22.29 22.29 0 0 0 -31.53 0l-76.72 76.72-76.72-76.72a22.29 22.29 0 0 0 -31.53 0l-25.22 25.22a22.29 22.29 0 0 0 0 31.53l76.72 76.72-76.72 76.72a22.29 22.29 0 0 0 0 31.53l25.22 25.22a22.29 22.29 0 0 0 31.53 0l76.72-76.72 76.72 76.72a22.29 22.29 0 0 0 31.53 0l25.22-25.22a22.29 22.29 0 0 0 0-31.53z" fill="#fff"></path>
                                        </g></g></svg>
            ...
            <div class="card-wrapper border rounded-3 input-radius">
                    ...
                    <div class="col-xxl-4 col-sm-6">
                        ...
                        <select class="form-select @error('length_of_metting') is-invalid @enderror"
                            ...
                            @foreach (config('booking.length_of_metting') as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('length_of_metting') == $key ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row g-3 mt-2">
                    @php
                        ...
                        $selectedMeetings = old('follow_up_meeting', []);
                    @endphp
