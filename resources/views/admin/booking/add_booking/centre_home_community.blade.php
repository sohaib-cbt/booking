...
<form class="row g-3 needs-validation custom-input" action="{{ route('bookings.store') }}" method="POST">
    ...
    <div class="col-xxl-4 col-sm-6">
        <label class="form-label" for="alayacare_type">Alayacare Activity Type<span class="txt-danger">*</span></label>
    ...
    <div class="col-xxl-4 col-sm-6">
        ...
        <select class="form-select meri-class @error('therapist') is-invalid @enderror therapist" id="therapist1"
    ...
    <div class="card-wrapper border rounded-3 input-radius">
        ...
        <div class="row g-3">
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="input-group">
                    <div class="input-group-text">
                        <input class="form-check-input mt-0" name="inform_to[]" type="checkbox" value="parent_only"
