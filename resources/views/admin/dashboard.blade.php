              ...
              <div class="col-xl-4 col-md-6 box-col-5 total-revenue-total-order">
                <div class="row">
                  <div class="col-xl-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="total-revenue mb-2"> <span>Total Revenue</span></div>
                        ...
                        <div class="total-chart">
                          ...
                          <div class="total-revenue-chart">
                            <div>
                                <img height="100px" src="{{ asset('assets/images/booking.png') }}" alt="">
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="col-xl-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="total-revenue mb-2"> <span>Total Order   </span></div>
                    ...
                    <div class="table-order table-responsive custom-scrollbar">
                      <table class=" latest-orders w-100">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="product-name"><img class="order-table-images img-fluid" src="../assets/images/dashboard/order-table/1.png" alt="product">
                            ...
                            <td>
                              <div class="product-sub">
                                <svg class="invoice-icon">
                                  <use href="../assets/svg/icon-sprite.svg#fream"></use>
                                </svg>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <div class="product-name"><img class="order-table-images img-fluid" src="../assets/images/dashboard/order-table/2.png" alt="product">
                          ...
                          <tr>
                            <td>
                              <div class="product-name"><img class="order-table-images img-fluid" src="../assets/images/dashboard/order-table/3.png" alt="product">
                          ...
                          <tr>
                            <td>
                              <div class="product-name"><img class="order-table-images img-fluid" src="../assets/images/dashboard/order-table/4.png" alt="product">
