                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Create Therapist</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-wrapper border rounded-3">
                                <form class="row g-3" action="{{ route('therapists.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label" for="inputPhone">Email</label>
                                        <input class="form-control @error('email') is-invalid @enderror" id="inputPhone" type="text" name="email" placeholder="Enter email" value="{{ old('email') }}">
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
