                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-wrapper border rounded-3">
                                <form class="row g-3" action="{{ route('rooms.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="col-md-12">
                                     ...
                                     <div class="col-12">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea-01" name="description" rows="3" placeholder="Enter your queries..."></textarea>
                                    </div>
