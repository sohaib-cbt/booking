(function ($) {
    ...
    if (localStorage.getItem("color")) {
        $("#color").attr(
            "href",
            `${baseUrl}/assets/css/${localStorage.getItem("color")}.css`
        );
    }
    ...
    <div class="tab-content" id="c-pills-tabContent">
      ...
      <div class="customizer-body custom-scrollbar">
        <div class="tab-pane fade show active" id="c-pills-home" role="tabpanel" aria-labelledby="c-pills-home-tab">
          ...
          <h5>Layout Type</h5>
          <ul class="main-layout d-flex align-items-center layout-grid">
          ...
          <ul class="sidebar-type layout-grid">
            ...
            <li data-attr="compact-sidebar">
              <div class="header bg-light"><ul><li></li><li></li><li></li></ul></div>
              <div class="body"><ul><li class="bg-dark sidebar compact"></li><li class="bg-light body"></li></ul></div>
            </li>
          </ul>
          ...
          <ul class="layout-grid unlimited-color-layout">
            <input id="ColorPicker1" type="color" value="#006666" name="Background">
            <input id="ColorPicker2" type="color" value="#FF6150" name="Background">
            <button type="button" class="color-apply-btn btn btn-primary color-apply-btn">Apply</button>
          </ul>

          <h5>Light layout</h5>
          <ul class="layout-grid customizer-color">
            <li class="color-layout" data-attr="color-1" data-primary="#006666" data-secondary="#FF6150"><div></div></li>
            <li class="color-layout" data-attr="color-2" data-primary="#1D5B79" data-secondary="#A16B56"><div></div></li>
            <li class="color-layout" data-attr="color-3" data-primary="#4A55A2" data-secondary="#F0A360"><div></div></li>
            <li class="color-layout" data-attr="color-4" data-primary="#167A93" data-secondary="#eeb82f"><div></div></li>
            <li class="color-layout" data-attr="color-5" data-primary="#423964" data-secondary="#FFA47A"><div></div></li>
            <li class="color-layout" data-attr="color-6" data-primary="#4b2a4b" data-secondary="#FE7088"><div></div></li>
          </ul>

          <h5>Dark Layout</h5>
          <ul class="layout-grid customizer-color dark">
            <li class="color-layout" data-attr="color-1" data-primary="#006666" data-secondary="#FE6A49"><div></div></li>
            <li class="color-layout" data-attr="color-2" data-primary="#1D5B79" data-secondary="#468B97"><div></div></li>
            <li class="color-layout" data-attr="color-3" data-primary="#4A55A2" data-secondary="#F0A360"><div></div></li>
            <li class="color-layout" data-attr="color-4" data-primary="#167A93" data-secondary="#eeb82f"><div></div></li>
            <li class="color-layout" data-attr="color-5" data-primary="#423964" data-secondary="#897D5e"><div></div></li>
            <li class="color-layout" data-attr="color-6" data-primary="#4b2a4b" data-secondary="#FE7088"><div></div></li>
          </ul>
          ...
          <ul class="layout-grid customizer-mix">
            <li class="color-layout active" data-attr="light-only">
              <div class="header bg-light"><ul><li></li><li></li><li></li></ul></div>
              <div class="body"><ul><li class="bg-light sidebar"></li><li class="bg-light body"></li></ul></div>
            </li>
            ...
            <li class="color-layout" data-attr="dark-only">
              ...
              <div class="body"><ul><li class="bg-dark sidebar"></li><li class="bg-dark body"></li></ul></div>
            </li>
          </ul>
        ...
        $(".sidebar-type li").on("click", function () {
            ...
            switch (type) {
                ...
                case "normal-sidebar": {
                    ...
                    $(".logo-wrapper")
                        .find("img")
                        .attr("src", `${baseUrl}/assets/images/logo/logo.png`);
                ...
                case "enterprice-type": {
                    $(".page-wrapper").attr(
                        "class",
                        "page-wrapper horizontal-wrapper enterprice-type" +
                            boxed
                    );
                    localStorage.setItem(
                        "page-wrapper",
